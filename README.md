...
## Citation
Gunn, M. P., & Grisafe, D. J. (2025). *roi-mask-builder: A MATLAB tool for generating combined binary ROI masks from indexed atlas NIfTI files.* GitHub. https://github.com/MPG-Git/roi-mask-builder
